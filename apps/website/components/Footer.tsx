          ...
          <div className="mb-24 flex md:mb-0">
            ...
            >
              <div className="relative group">
                ...
                <div className="absolute -inset-0.5 bg-gradient-to-r from-[#5B6FF8] to-[#7D8CFA] full blur opacity-75 group-hover:opacity-100 transition duration-1000 group-hover:duration-200 animate-tilt"></div>
                <div className="relative">
                  <Image
                    ...
                    height={100}
                    alt="webui logo"
                    className="hidden dark:block rounded-lg shadow-lg dark:shadow-gray-700/50 transition duration-300 group-hover:scale-110"
                  />
                  <Image
                    ...
                    height={100}
                    alt="webui logo"
                    className="dark:hidden shadow-lg rounded-lg shadow-gray-300/50 transition duration-300 group-hover:scale-110"
                  />
                </div>
              </div>
            </a>
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
              ...
              <ul className="text-black/50 dark:text-white/50 font-medium">
                <li className="mb-4">
                  <a href="https://gopx.dev/" className="hover:underline">
                    GOPX
                  </a>
                </li>
                <li>

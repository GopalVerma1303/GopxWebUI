---
title: "GOPX WEBUI"
description: "Enhance your projects with our pre-built Tailwind CSS and Framer Motion components. Simply copy, paste, and customize to fit your needs."
---
...
<style jsx>{`
    ...
    .headline {
      display: inline-flex;
      font-size: 3.125rem;
      font-size: min(3.375rem, max(8vw, 2.5rem));
      font-weight: 700;

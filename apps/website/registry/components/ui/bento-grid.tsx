...
const BentoGrid: React.FC = () => {
  const baseUrl = "https://webui.gopx.dev/assets/hero/bento";

  const cards: Card[] = [
    {
      bgImage: `${baseUrl}/1.png`,
      url: "/components",
      className: "col-span-1 row-span-1",
      title: "Components",
    },
    {
      bgImage: `${baseUrl}/6.png`,
      url: "/tools/shadows",
      className: "col-span-2 row-span-1",
      title: "Shadow Generator",
    },
    {
      bgImage: `${baseUrl}/2.png`,
      className: "col-span-1 row-span-1",
      url: "/store?tab=Templates",
      title: "Templates",
    },
    {
      bgImage: `${baseUrl}/7.png`,
      url: "/store?tab=Component%20Packs",
      className: "col-span-1 row-span-1",
      title: "Packs",
    },
    {
      bgImage: `${baseUrl}/4.png`,
      className: "col-span-1 row-span-1",
      url: "/pricing",
      title: "Pricing",
    },
    {
      bgImage: `${baseUrl}/3.png`,
      className: "col-span-2 row-span-1",
      url: "/tools/colors",
      title: "Color Generator",
    },
    {
      bgImage: `${baseUrl}/5.png`,
      className: "col-span-1 row-span-1",
      url: "/faqs",
      title: "FAQs",
    },
